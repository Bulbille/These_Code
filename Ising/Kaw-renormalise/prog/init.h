...
const int TAILLE_X =60;
const int TAILLE_Y = 150;
const int N = TAILLE_X*TAILLE_Y;
const int L_FAISCEAU = 15;
...
const int T_PHOTO = 1.0e4;
const double NB_PHOTO = 1e4;
const double T_MAX = 1.*T_PHOTO*NB_PHOTO;
const double T_CHAMP=5e4;
const double T_THERM=2e4;
